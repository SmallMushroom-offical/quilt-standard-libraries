...
final class ChannelScreen extends Screen {
	...
	protected void init() {
		...
		this.addDrawableSelectableElement(ButtonWidget.builder(Text.literal("Close"), button -> this.closeScreen())
				...
				.build());
		this.channelList = this.addDrawableSelectableElement(new ChannelList(this.client, this.width, this.height - 60, 30, this.height - 30, this.textRenderer.fontHeight + 2));
	}
